...
import pandas as pd
# TODO check this, this functions are actually typed
from guacamol.assess_distribution_learning import \
    assess_distribution_learning  # type: ignore
from guacamol.distribution_matching_generator import \
    DistributionMatchingGenerator  # type: ignore
...
class GuacaMolEval(DistributionMatchingGenerator):
    ...
    def _read_molecules_from_file(
        ...
        # TODO this return an ndarray, not a list of strings, so we need to convert it
